...
export default function IOSBatteryPercentage() {
  ...
  return (
    <div className="ios-battery-percentage-wrapper flex flex-col items-center justify-start gap-3">
      <div className="battery-wrapper flex flex-row items-center justify-center relative">
        <div className="battery-fill-container w-40 h-16 border-4 border-white rounded-lg p-1 bg-zinc-900 rounded-xl flex flex-row items-center justify-center">
        ...
        <div className="battery-point-container w-4 h-4 rounded-full bg-white -ml-2 absolute -right-2"></div>
      </div>
